...
export default function PaywallModal({
  ...
  const triggerMessages = {
    ...
    mas_tab: isPremium
      ...
      : 'Desbloquea todas las ventajas de Etiove Premium.',
  };
          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            >
              ...
              <View style={styles.planBtnGhost}>
                <Text style={styles.planBtnGhostText}>
            ...
            {!revenueCatReady ? (
              <Text style={styles.setupNote}>
                Configura las claves públicas de RevenueCat y usa una build nativa para habilitar
                compras reales.
              </Text>
            ) : null}

            <Text style={styles.legal}>
              El pago se procesará a través de App Store o Google Play. La suscripción mensual se
              renueva automáticamente. Puedes cancelar en cualquier momento desde los ajustes de tu
              cuenta.
            </Text>
          </Animated.View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  sealMiddle: {
    ...
    borderRadius: 28,
    borderWidth: 1,
    borderColor: 'rgba(143,94,59,0.25)',
    alignItems: 'center',
    justifyContent: 'center',
  },
  sealInner: {

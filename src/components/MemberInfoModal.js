    ...
    <Modal visible={!!visible} transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 18, fontWeight: '900', color: '#fff8f0' }}>
          ...
          <View style={{ gap: 8, marginTop: 4 }}>
            ...
            >
              ...
              <Text style={{ fontSize: 13, fontWeight: '900', color: '#8f5e3b' }}>
                +{XP_RULES.vote} XP
              </Text>
            </View>
            <View
            ...
            >
              <Text style={{ fontSize: 13, fontWeight: '700', color: '#1f140f' }}>
                Cafés añadidos
              </Text>
              <Text style={{ fontSize: 13, fontWeight: '900', color: '#8f5e3b' }}>
                +{XP_RULES.addCafe} XP
            ...
            >
              ...
              <Text style={{ fontSize: 13, fontWeight: '900', color: '#8f5e3b' }}>
                +{XP_RULES.favorite} XP
              </Text>
            </View>
          </View>

          <Text style={{ fontSize: 12, lineHeight: 18, color: '#f4dfc8', marginTop: 2 }}>

...
const cafes = [
  ...
  },
  {
    ...
    region: "La Réunion, Hauts de l'île",
    finca: 'Cafés Bourbon Pointu ARRC',
    productor: 'Cooperativa ARRC',
    altura: 1200,
    variedad: 'Bourbon Pointu (Laurina)',
    proceso: 'Lavado',
    secado: 'Mecánico controlado',
    tueste: 'Claro',
    fechaTueste: '2026-03-18',
    notas: 'Floral muy intenso, cítrico complejo, acidez única, notas de té',
    acidez: 'Muy brillante y única en el mundo',
  ...
  },
  {
    ...
    finca: 'Terrazas ancestrales de Haraz',
    ...
    acidez: 'Muy baja y vinosa',
    cuerpo: 'Denso y complejo',
    regusto: 'Especiado ancestral muy largo',
    puntuacion: 5,
    sca: 91,
    votos: 445,
  ...
  },
  {
    ...
    altura: 1850,
    variedad: 'Geisha',
    proceso: 'Anaeróbico natural 96 horas',
    secado: 'Camas africanas',
    tueste: 'Claro',
    fechaTueste: '2026-03-19',
    notas: 'Pitaya, lichi, flores exóticas, vino blanco, fruta de la pasión',
    acidez: 'Exótica y muy compleja',
  ...
  },
  {
    ...
    productor: 'Wallenford Coffee Company',
    altura: 1500,
    variedad: 'Typica jamaicana',
    proceso: 'Lavado',
    secado: 'Mecánico controlado en barril de madera',
    tueste: 'Medio',
    fechaTueste: '2026-03-17',
    notas: 'Nuez de macadamia, chocolate suave, hierbas alpinas, caramelo, sin amargor',
    acidez: 'Suave y muy equilibrada',
    cuerpo: 'Medio y sedoso',
    regusto: 'Limpio, dulce y prolongado',
    puntuacion: 5,
    sca: 90,
    votos: 523,
...
async function main() {
  if (!PID || !TOKEN) {
    ...
    console.log(
      'Ejemplo: FIREBASE_PROJECT_ID=miappdecafe FIREBASE_AUTH_TOKEN=eyJ... node seed5.js\n'
    );
    return;
  }
  ...
  for (const cafe of cafes) {
    ...
    if (res.ok) {
      ...
      console.log(`❌ ${cafe.nombre}: ${e.substring(0, 80)}`);
    }
    await sleep(400);
  }

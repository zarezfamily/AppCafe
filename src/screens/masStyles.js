...
const mas = StyleSheet.create({
  ...
  blogCard: { position: 'relative', overflow: 'hidden', backgroundColor: '#f8efe6', borderRadius: 18, borderWidth: 1, borderColor: '#e3cfbc', padding: 16, marginBottom: 14 },
  blogCardGlow: { position: 'absolute', width: 150, height: 150, borderRadius: 75, right: -40, top: -48, backgroundColor: 'rgba(143, 94, 59, 0.08)' },
  blogKicker: { color: '#8f5e3b', fontSize: 10, fontWeight: '800', letterSpacing: 1.2, marginBottom: 8 },
  ...
  blogActionRow: { marginTop: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  blogActionPill: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 999, backgroundColor: '#2f1d14', paddingHorizontal: 12, paddingVertical: 8 },
  ...
  iconWrap: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#f6ede3', alignItems: 'center', justifyContent: 'center' },

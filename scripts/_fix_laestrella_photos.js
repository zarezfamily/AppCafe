...
const cafes = [
  {
    docId: 'laestrella_https-www-cafeslaestrella-com-productos-molido-descafeinado-mezcla-html',
    asin: 'B008GTCI84',
    name: 'Descafeinado Mezcla',
  },
  {
    docId: 'laestrella_https-www-cafeslaestrella-com-productos-molido-mezcla-intensa-html',
    asin: 'B00709HL8S',
    name: 'Mezcla Intensa',
  },
];
...
(async () => {
  ...
  console.log('\nAll La Estrella photos updated!');
  process.exit(0);
})();

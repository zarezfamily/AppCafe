...
(async () => {
  const docId =
    'fortaleza_https-www-cafefortaleza-com-tienda-online-11202-cafe-grano-colombia-500g-html';
  const asin = 'B0GY8TBY1R';
  ...
  console.log('DONE - Fortaleza Colombia updated!');
  process.exit(0);
})();

const cafeDeEspecialidadVsCafeNormal = {
  ...
  search:
    'cafe de especialidad vs cafe normal diferencia que es especialidad sca puntuacion 80 puntos origen single origin trazabilidad tueste frescura precio productor sabor comparacion',
};
